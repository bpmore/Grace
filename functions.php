...
add_filter( 'the_content_more_link', 'carry_read_more' );
function carry_read_more() {
...
//function carry_post_info_filter($post_info) {
...
add_filter('genesis_footer_creds_text', 'carry_footer_creds_filter');
function carry_footer_creds_filter( $creds ) {
